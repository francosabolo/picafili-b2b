...
export type CustomerCompanyQueryVariables = CustomerAccountAPI.Exact<{
  minimumOrderIdentifiers:
    | Array<CustomerAccountAPI.HasMetafieldsIdentifier>
    | CustomerAccountAPI.HasMetafieldsIdentifier;
}>;
...
export type DraftOrderAddressFragment = Pick<
  CustomerAccountAPI.CustomerAddress,
  | 'firstName'
  | 'address1'
  | 'address2'
...
export type DraftOrderLineItemFragment = Pick<
  CustomerAccountAPI.DraftOrderLineItem,
  'id' | 'title' | 'quantity' | 'variantTitle'
> & {
  discountedUnitPrice: Pick<
    CustomerAccountAPI.MoneyV2,
    'amount' | 'currencyCode'
  >;
  discountedTotal: Pick<CustomerAccountAPI.MoneyV2, 'amount' | 'currencyCode'>;
  originalUnitPrice: Pick<
    CustomerAccountAPI.MoneyV2,
    'amount' | 'currencyCode'
  >;
...
export type DraftOrderQueryVariables = CustomerAccountAPI.Exact<{
  id: CustomerAccountAPI.Scalars['ID']['input'];
}>;

export type DraftOrderQuery = {
  draftOrder?: CustomerAccountAPI.Maybe<
    Pick<
    ...
    > & {
      ...
      lineItemsSummary?: CustomerAccountAPI.Maybe<
        Pick<
          CustomerAccountAPI.DraftOrderLineItemsSummary,
          'lineItemCount' | 'totalQuantityOfLineItems'
        >
      >;
      totalTax: Pick<CustomerAccountAPI.MoneyV2, 'amount' | 'currencyCode'>;
      ...
      totalLineItemsPrice: Pick<
        CustomerAccountAPI.MoneyV2,
        'amount' | 'currencyCode'
      >;
      customer?: CustomerAccountAPI.Maybe<
        Pick<CustomerAccountAPI.Customer, 'id' | 'displayName'>
      >;
      discountInformation: {
        totalDiscounts: Pick<
          CustomerAccountAPI.MoneyV2,
...
export type DraftOrderItemFragment = Pick<
  CustomerAccountAPI.DraftOrder,
  'status' | 'id' | 'name' | 'createdAt'
> & {
  totalPrice: Pick<CustomerAccountAPI.MoneyV2, 'amount' | 'currencyCode'>;
  shippingAddress?: CustomerAccountAPI.Maybe<
    Pick<CustomerAccountAPI.CustomerAddress, 'firstName'>
  >;
};

export type CustomerDraftOrdersFragment = {
  draftOrders: {
    nodes: Array<
      Pick<
        CustomerAccountAPI.DraftOrder,
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n\n\nfragment DraftOrderAddress on CustomerAddress {\n    firstName\n    address1\n    address2\n    city\n    company\n    country\n    id\n    name\n    phoneNumber\n}\n\nfragment DraftOrderLineItem on DraftOrderLineItem {\n    id\n    title\n    quantity\n    discountedUnitPrice {\n        amount\n        currencyCode\n    }\n    discountedTotal {\n        amount\n        currencyCode\n    }\n    originalUnitPrice {\n        amount\n        currencyCode\n    }\n    image {\n      altText\n      height\n      url\n      id\n      width\n    }\n    variantTitle\n  }\n\nquery draftOrder($id: ID!) {\n    draftOrder(id: $id) {\n        id\n        name\n        email\n        createdAt\n        status\n        inReview\n        invoiceUrl\n        lineItems(first: 100) {\n            nodes {\n                ...DraftOrderLineItem\n            }\n        }\n        lineItemsSummary {\n            lineItemCount\n            totalQuantityOfLineItems\n        }\n        phone\n        currencyCode\n        totalTax {\n            amount\n            currencyCode\n        }\n        billingAddress {\n            ...DraftOrderAddress\n        }\n        shippingAddress {\n            ...DraftOrderAddress\n        }\n        totalShippingPrice {\n            amount\n            currencyCode\n        }\n        totalPrice {\n            amount\n            currencyCode\n        }\n        totalLineItemsPrice {\n            amount\n            currencyCode\n        }\n        customer {\n            id\n            displayName\n        }\n        totalWeight\n        updatedAt\n        discountInformation {\n            totalDiscounts {\n                amount\n                currencyCode\n            }\n        }\n    }\n}': {
    return: DraftOrderQuery;
    variables: DraftOrderQueryVariables;
  };
